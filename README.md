...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/maxsupun/Radio-Player.git)


NOTE: Change the  to Europe (it will help to make the bot stable)
